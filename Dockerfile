...
WORKDIR /src
RUN git clone https://github.com/libsidplayfp/libsidplayfp -b ${SIDPLAY_VERSION} --recurse-submodules
RUN git clone https://github.com/libsidplayfp/sidplayfp -b ${SIDPLAY_VERSION}
